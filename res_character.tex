...
\end{eqnarray}
\end{subequations}
where $\Delta = r^2 - 2M r + a^2$ and $a$ is the spin parameter. We also use the dimensionless spin $a_\ast \equiv a/M$; we take the convention that $0 \leq a_\ast < 1$. The signs of the $r$ and $\theta$ equations may be chosen independently. We have introduced potentials
\begin{subequations}
\begin{eqnarray}
