...
\begin{subequations}
\begin{eqnarray}
\varrho^2 \diff{t}{\lambda} & = & a\left(L_z - aE\sin^2 \theta\right) + \frac{r^2 + a^2}{\Delta}\mathcal{T},\\
\varrho^2 \diff{r}{\lambda} & = & \pm \sqrt{V_r},\\
\varrho^2 \diff{\theta}{\lambda} & = & \pm \sqrt{V_\theta},\\
\varrho^2 \diff{\phi}{\lambda}&  = & \frac{L_z}{\sin^2 \theta} - aE + \frac{a}{\Delta}\mathcal{T},
\end{eqnarray}
\end{subequations}
