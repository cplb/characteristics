...
% i.e. it should be accompanied by an EPS file (fit_error_RMS-psfrag.eps). 
...
\psfrag{m}[Br][Br]{\PFGstyle {\Large$\left({\displaystyle\frac{\Delta p}{p}}\right)_\mathrm{RMS}$}}%
\psfrag{r}[Bc][Bc]{\PFGstyle {\Large$\nu$}}%
%
% Figure:
\resizebox{12cm}{!}{\includegraphics{fit-error-RMS.eps}}%
\end{psfrags}%
